...
(function($) {
        ...
        var infoWindowContent = `
            <div class="bw-map-info-window">
                ...
                <div class="bw-info-content">
                    ...
                    ${member.member_since_formatted ? `<p style="margin: 0; font-size: 11px; color: #888;">Member since ${member.member_since_formatted}</p>` : ''}
    ...
    function buildMemberCardHTML(member) {
        var bannerHTML = member.banner_url 
            ? `<img src="${escapeHtml(member.banner_url)}" alt="${escapeHtml(member.business_name)} banner" class="bw-banner-image" />`
        ...
        var memberSinceHTML = member.member_since_formatted
            ? `<div class="bw-member-since"><span class="dashicons dashicons-calendar"></span><span class="bw-since-text">Member since ${member.member_since_formatted}</span></div>`
            : '';        
