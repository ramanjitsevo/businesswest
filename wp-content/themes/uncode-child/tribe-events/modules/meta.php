...
<?php if ( $not_skeleton ) : ?>
	<div class="tribe-events-single-section tribe-events-event-meta primary tribe-clearfix d-flex">
<?php endif; ?>
...
if ( tribe_get_venue_id() ) {
	...
	if ( ! $set_venue_apart && ! tribe_embed_google_map() ) {
		...
		tribe_get_template_part( 'modules/meta/venue' );
		echo '<div class="tribe-events-meta-group tribe-events-meta-group-gmap w-auto">';
