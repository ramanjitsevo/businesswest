...
.unmenu-block .unmenu-title > span .menu-item-description {
  font-size: <?php echo sanitize_text_field($small_text_font_size) . ($small_text_font_size > 0 && is_numeric( $small_text_font_size ) ? 'px' : ''); ?>;
}
/* #Font-size-large */
.font-size-large,
.form-large input,
...
.form-large .select2-selection--single {
  font-size: <?php echo sanitize_text_field($large_text_font_size) . ($large_text_font_size > 0 && is_numeric( $large_text_font_size ) ? 'px' : ''); ?>;
}
/* #Font-ui-fixed */
.font-ui-fixed,
.post-info,
...
body.uncode-accessible .btn-link {
  outline-color: <?php echo sanitize_text_field($color_primary); ?> !important;
}
/* #Paragraph-color */
...
.style-light .style-dark .dots-look-border:not(.dots-numbers).uncode-owl-nav .uncode-nav-index span:after {
  border-color: <?php echo sanitize_text_field($color_heading_inverted); ?>;
}
...
.style-light .unmenu-block > li a:focus {
  color: <?php echo sanitize_text_field($color_heading_alpha_05); ?>;
}
...
.style-dark .unmenu-block > li a:focus {
  color: <?php echo sanitize_text_field($color_heading_inverted_alpha_05); ?>;
}
/* #Woo Headings */
.headings-style-woo {
  font-size: 17px;
...
@media (min-width: 960px) {
  ...
  #uncode-custom-cursor-pilot.blur-style > span:first-child {
    background-color: <?php echo sanitize_text_field($color_heading_alpha_01); ?>;
  }
...
@media (min-width: 960px) {
  ...
  .burger-label,
  #masthead .overlay .overlay-search-wrapper .search-container {
    font-size: <?php echo sanitize_text_field($menu_font_size) . ($menu_font_size > 0 && is_numeric( $menu_font_size ) ? 'px' : ''); ?>;
  }
  .font-size-submenu,
  ...
  .vmenu-container ul ul .unmenu-title:not(.font-size-title-custom) {
    font-size: <?php echo sanitize_text_field($submenu_font_size) . ($submenu_font_size > 0 && is_numeric( $submenu_font_size ) ? 'px' : ''); ?>;
  }
  ...
  .menu-bloginfo .menu-bloginfo-inner > * {
    font-size: <?php echo sanitize_text_field($secondary_menu_font_size) . ($secondary_menu_font_size > 0 && is_numeric( $secondary_menu_font_size ) ? 'px' : ''); ?>;
  }
  .font-size-overlay-menu,
  .menu-overlay .vmenu-container.menu-container:not(.grid-filters) .menu-smart a:not(.wc-forward) {
    font-size: <?php echo sanitize_text_field($menu_overlay_font_size) . ($menu_overlay_font_size > 0 && is_numeric( $menu_overlay_font_size ) ? 'px' : ''); ?>;
  }
  .font-size-overlay-submenu,
  .menu-overlay .vmenu-container.menu-container:not(.grid-filters) .menu-smart ul a:not(.wc-forward) {
    font-size: <?php echo sanitize_text_field($submenu_overlay_font_size) . ($submenu_overlay_font_size > 0 && is_numeric( $submenu_overlay_font_size ) ? 'px' : ''); ?>;
  }
}
@media (max-width: 959px) {
  .font-size-menu-mobile,
  .menu-container:not(.grid-filters) ul.menu-smart a:not(.social-menu-link):not(.vc_control-btn):not(li.font-size-custom > *):not(.uncont .font-size-custom *) {
    font-size: <?php echo sanitize_text_field($menu_mobile_font_size) . ($menu_mobile_font_size > 0 && is_numeric( $menu_mobile_font_size ) ? 'px' : ''); ?> !important;
  }
  .font-size-secondary-menu-mobile,
  .top-menu-enhanced .menu-mini.menu-smart a:not(.uncode-vc-social *),
  .top-menu-enhanced .menu-mini.unmenu-block a:not(.uncode-vc-social *),
  .top-menu-enhanced .menu-bloginfo .menu-bloginfo-inner {
    font-size: <?php echo sanitize_text_field($secondary_menu_mobile_font_size) . ($secondary_menu_mobile_font_size > 0 && is_numeric( $secondary_menu_mobile_font_size ) ? 'px' : ''); ?>;
  }
  ...
  body.menu-mobile-centered .overlay-menu .navbar-main .menu-sidebar-inner ul.menu-smart.menu-primary-inner > li .unmenu-title:not(li.font-size-custom > *):not(.uncont .font-size-custom *) {
    font-size: <?php echo sanitize_text_field($menu_mobile_centered_font_size) . ($menu_mobile_centered_font_size > 0 && is_numeric( $menu_mobile_centered_font_size ) ? 'px' : ''); ?> !important;
  }
  ...
  body.menu-mobile-centered .overlay-menu .navbar-main .menu-sidebar-inner ul.menu-smart.menu-primary-inner ul li.menu-item-link > a:not(li.font-size-custom > *):not(.uncont .font-size-custom *) {
    font-size: <?php echo sanitize_text_field($submenu_mobile_centered_font_size) . ($submenu_mobile_centered_font_size > 0 && is_numeric( $submenu_mobile_centered_font_size ) ? 'px' : ''); ?> !important;
  }
}
/* #Font-weight-menu */
.font-weight-menu,
...
.unmenu-block .unmenu-title {
  font-weight: <?php echo sanitize_text_field($menu_font_weight); ?>;
  letter-spacing: <?php echo sanitize_text_field($menu_letter_spacing) . ($menu_letter_spacing > 0 && is_numeric( $menu_letter_spacing ) ? 'em' : ''); ?>;
}
.topbar-font-weight,
.top-menu.top-menu-enhanced {
...
.submenu-light .unmenu-block > li a:not(.unmenu-title *):focus {
  color: <?php echo sanitize_text_field($color_submenu_hover_enhanced); ?>;
}
...
.submenu-dark .unmenu-block > li a:not(.unmenu-title *):focus {
  color: <?php echo sanitize_text_field($color_submenu_enhanced_hover_inverted); ?>;
}
/* Menu colors mobile */
@media (max-width: 959px) {
  .submenu-light:not(.isotope-filters) .menu-smart a:not(.block-wrapper-parent *) {
