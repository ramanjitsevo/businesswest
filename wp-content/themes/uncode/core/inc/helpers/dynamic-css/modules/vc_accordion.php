 ...
 */
function uncode_get_dynamic_colors_css_for_shortcode_vc_accordion( $shortcode, $custom_color_keys ) {
	$accepted_keys = array(
		'active_bg_color'    => array( 'bg' ),
		'active_txt_color'   => array( 'hover', 'active' ),
    );
