	...
	if ( isset( $swatches[$key] ) && $swatches[$key]['type'] ) {
		...
		switch ( $type ) {
			case 'color':
				...
				echo '<div class="' . esc_attr( implode( ' ', $swatch_classes ) ) . '" role="button" tabindex="0" data-swatch-value="' . esc_attr( $term->slug ) . '" data-swatch-title="' . esc_attr( $term->name ) . '" style="background-color:'. esc_attr( $color ) . '" ' . $data_variation . '><span>' . esc_html( $term->name ) . $swatch_description. '</span></div>';
				break;
			...
			case 'image':
				...
				echo '<div class="' . esc_attr( implode( ' ', $swatch_classes ) ) . '" role="button" tabindex="0"  data-swatch-value="' . esc_attr( $term->slug ) . '" data-swatch-title="' . esc_attr( $term->name ) . '" style="background-image:url('. esc_url( $image ) . ')" ' . $data_variation . '><span>' . esc_html( $term->name ) . $swatch_description . '</span></div>';
				break;
			...
			case 'featured':
				...
				echo '<div class="' . esc_attr( implode( ' ', $swatch_classes ) ) . '" role="button"  tabindex="0"  data-swatch-value="' . esc_attr( $term->slug ) . '" data-swatch-title="' . esc_attr( $term->name ) . '" ' . $data_variation . '><span>' . $image . $swatch_description . '</span></div>';
				break;
			...
			case 'label':
				...
				echo '<div class="' . esc_attr( implode( ' ', $swatch_classes ) ) . '" role="button"  tabindex="0"  data-swatch-value="' . esc_attr( $term->slug ) . '" data-swatch-title="' . esc_attr( $term->name ) . '" ' . $data_variation . '><span>' . esc_html( $term->name ) . $swatch_description . '</span></div>';
				break;
		}
	}
}
