...
global $row_cols_md_counter, $row_cols_sm_counter, $inner_column_style, $front_background_colors, $previous_blend, $is_cb, $uncode_vc_block, $uncode_colors_flat_array, $changer_back_first, $changer_back_color_div, $changer_back_color_row, $changer_back_color_row_inner, $changer_back_color_column_inner, $is_footer, $bento, $uncode_in_navbar;
...
if ( $changer_back_color === 'yes' && ( ( $back_color_type == 'uncode-palette' && isset($front_background_colors[$back_color]) && in_array( $back_color, $uncode_colors_flat_array ) ) || ( $back_color_type == 'uncode-solid' && $back_color !== '' ) ) )  {
	...
	if (!empty($back_color) ) {
		$row_cont_classes[] = 'has-bg need-focus';
		$row_cont_classes[] = 'style-' . $back_color . '-bg';
	}
...
if ( $no_h_border === 'yes' ) {
	if ( $no_h_border_tablet === 'yes' ) {
		$row_cont_classes[] = 'vc_custom_no_h_tablet';
	}
	if ( $no_h_border_mobile === 'yes' ) {
		$row_cont_classes[] = 'vc_custom_no_h_mobile';
	}
}
...
if ( $container_limit_width !== '' ) {
	$container_limit_width = (is_numeric( $container_limit_width ) ? $container_limit_width . 'px' : esc_html($container_limit_width));
	$row_cont_classes[] = 'row-parent-limit';
	$row_style .= '--uncode-box-width:' . $container_limit_width . ';';
}
