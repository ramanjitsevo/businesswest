<div class="arm_form_field_block">
    <label class="arm-form-table-label"><?php esc_html_e('Child user signup page', 'ARMGroupMembership'); ?></label>
    <div class="arm-form-table-content">
		...
		<span class="arm_error_msg <?php echo ($is_valid_md_page) ? 'arm_no_error' : ''; ?>"><?php esc_html_e('Shortcode of child user register not found on selected page. Please add shrotcode on that page Or please select appropriate page.', 'ARMGroupMembership'); ?></span>
    </div>
</div>