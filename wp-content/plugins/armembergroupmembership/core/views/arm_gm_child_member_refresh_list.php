<?php
    ...
    if(!empty($child_users_list))
    {
        ...
        foreach($child_users_list as $arm_gm_child_users_key => $arm_gm_child_users_val)
        {
            ...
            $arm_gm_tbody_content .= "<td data-label='".$arm_gm_membership_field_username."' class='arm_group_membership_list_item_plan_sr'>".$arm_gm_username."</td>";

            $arm_gm_tbody_content .= "<td data-label='".$arm_gm_membership_field_name."' class='arm_group_membership_list_item_plan_sr'>".$arm_gm_first_name.' '.$arm_gm_last_name."</td>";

            $arm_gm_tbody_content .= "<td data-label='".$arm_gm_membership_field_email."' class='arm_group_membership_list_item_plan_sr'>".$arm_gm_user_email."</td>";



            $arm_gm_tbody_content .= "<td data-label='".$arm_gm_membership_field_status."' class='arm_group_membership_list_item_plan_sr'>";
            $arm_gm_tbody_content .= "<div>".$arm_gm_status_text."<br>".__('Code:', 'ARMGroupMembership')." ";
            ...
            $arm_gm_tbody_content .= "</div>";
            $arm_gm_tbody_content .= "</td>";

            $arm_gm_tbody_content .= "<td data-label='".$arm_gm_membership_field_action."' class='arm_group_membership_list_item_plan_sr' style='text-align: left;'>";
            $arm_gm_tbody_content .= "<div class='arm_group_membership_action'>";
