...
<div class="wrap arm_page arm_report_analytics_main_wrapper">
    ...
    if ($setact != 1) {
        if($ARMember->arm_licence_notice_status()){
            ...
            ?>
            <div class="armember_notice_warning armember_licence_notice_warning">ARMember License is not activated. Please activate license from <a href="<?php echo esc_html($admin_css_url); ?>">here</a><span class="armember_close_licence_notice_icon" id="armember_close_licence_notice_icon" data-nonce="<?php echo $nonce;?>" data-type="armember" title="<?php esc_html_e('Dismiss for 7 days', 'ARMember'); ?>"></span></div>
    <?php }
    } ?>
                ...
                <div class="arm_report_analtics_filter_div">
                    ...
                    <div class="arm_filter_div">
                        <div class="arm_all_loginhistory_filter_inner">
                            ...
                            <button id="arm_login_history_page_export_btn" class="arm_cancel_btn arm_margin_0" type="button"><?php esc_html_e('Export To CSV', 'ARMember') ?></button>
                        </div>
                    </div>
                </div>
