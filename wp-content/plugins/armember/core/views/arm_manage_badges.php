...
function arm_load_badge_list_grid() {
    ...
    var __ARM_Showing_empty = '<?php echo addslashes(esc_html__('Showing 0 to 0 of 0 badges','ARMember')); //phpcs:ignore?>';
    ...
    var __ARM_Show = '<?php echo addslashes(esc_html__('Badges per page','ARMember')); //phpcs:ignore?>';
                ...
                <div class='sltstandard'>
                    <div class="arm_dt_filter_block arm_datatable_searchbox">
                        <div class="arm_datatable_filter_item">
                            <label class="arm_padding_0"><input type="text" placeholder="<?php esc_attr_e( 'Search Badges', 'ARMember' ); ?>" id="armmanagebadge_new" value="<?php echo esc_attr($filter_search); ?>" tabindex="-1"></label>
                        </div>				
                    </div>
                </div>
            </div>
