...
function arm_loadCouponData()
{
	...
	var __ARM_Coupon_List_Center = [0,1,7];
	...
	if( isset( $arm_group_membership ) ) {  ?>	
		...
		__ARM_Coupon_List_Center =[0,1,8];  
    ...
    var __ARM_Show = '<?php echo addslashes(esc_html__('Coupons per Page','ARMember')); //phpcs:ignore?>';
	...
	var table = jQuery('#armember_datatable').dataTable({
		...
		"aoColumnDefs": [
			...
			{"sClass": __ARM_subscription_plan_col_width, "aTargets":__ARM_subscription_plan_List_col},
        ],
		"oColVis": {
		   "aiExclude": [ 0, 9 ]
		},
				...
				<div class="sltstandard">
					<div class="arm_dt_filter_block arm_datatable_searchbox">
						<div class="arm_datatable_filter_item">
							<label class="arm_padding_0"><input type="text" placeholder="<?php esc_attr_e( 'Search Coupon', 'ARMember' ); ?>" id="armmanagesearch_coupon" value="<?php echo esc_attr($filter_search); ?>" tabindex="-1"></label>
						</div>				
					</div>
				</div>
			</div>
					...
					<table cellpadding="0" cellspacing="0" border="0" class="display arm_hide_datatable" id="armember_datatable">
						<thead>
							<tr>
								...
								<th class="arm_width_120"><?php esc_html_e('Subscription','ARMember');?></th>
			...
			<div class="content_wrapper arm_email_settings_content">
				...
				<form  method="post" action="#" id="arm_bulk_coupon_wrapper_frm" class="arm_add_edit_bulk_coupon_wrapper_frm arm_admin_form"> 
                    <div class="arm_admin_form_content arm_bulk_coupon_form_fields_popup_text">
					            ...
					            $c_data='';
					            ?>
					            <div class="arm_admin_form_content arm_padding_bottom_0 arm_margin_bottom_24">
					                <table class="form-table">
										<tr class="form-field form-required arm_width_100_pct">
											<td class="arm_padding_bottom_0 arm_padding_top_24">
										...
										<tr class="form-field form-required arm_width_100_pct arm_margin_top_8">
