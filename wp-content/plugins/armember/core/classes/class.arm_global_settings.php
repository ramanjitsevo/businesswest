            ...
            else
            {
                ...
                if ($setact != 1) {
                    $arm_addon_btn = '<div class="arm_feature_button_activate_wrapper ">
                        <a href="javascript:void(0)" style="padding:0 15px !important;" class="arm_feature_activate_btn arm_feature_activation_license" data-feature_val="1" data-feature="'. esc_attr($plugin_installer['short_name']).'">'. esc_html__('Activate License', 'ARMember').'</a>
                        <span class="arm_addon_loader">
                            <svg class="arm_circular" viewBox="0 0 60 60">
                                <circle class="path" cx="25px" cy="23px" r="18" fill="none" stroke-width="4" stroke-miterlimit="7"></circle>
                            </svg>
