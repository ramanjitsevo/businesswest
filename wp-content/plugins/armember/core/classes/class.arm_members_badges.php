	...
	class ARM_members_badges
	{
		...
		function arm_save_achievements_func()
		{
            ...
            if (!empty($badgeData) && !empty($action)) {
                ...
                $arm_require_badges_tootip = !empty($_POST['arm_require_badges_tootip']) ? sanitize_text_field($_POST['arm_require_badges_tootip']) : array();//phpcs:ignore
                    ...
                    if(is_array($achieve_num))
                    {
                        ...
                        { 
                            ...
                            $arm_achivement_edit_response .= '<input type="hidden" id="arm_require_achive_badges_id_'.$arm_achievement_cnt.'" 
                                                                ...
                                                                $arm_selected_achievement_badge = '<img src=\'' . esc_attr($arm_badges_require_icon['arm_badges_icon']) . '\' alt=\'\' class=\'arm_badge_icon arm_padding_top_8\' style=\''.$badge_css.'\' /><span class="arm_badge_title">'.stripslashes_deep($arm_badges_require_icon['arm_badges_name']).'</span>';
                            $arm_achivement_edit_response .= '<dl class="arm_selectbox arm_achievement_badge_select arm_badge_select column_level_dd arm_width_250" >
                                                                <dt><span>'.$arm_selected_achievement_badge.'</span><input type="text" style="display:none;" value="" class="arm_autocomplete" /><i class="armfa armfa-caret-down armfa-lg"></i></dt>
                                                                <dd>
                                                                    ...
                                                                    if(!empty($badges_list))
                                                                    {
                                                                        foreach ($badges_list as $badge) {
                                                                            ...
                                                                            */
                                                                            $arm_achivement_edit_response .= '<li data-value="'.$badge->arm_badges_id.'" data-label="<img src=\'' . ($badge->arm_badges_icon) . '\' alt=\'\' class=\'arm_badge_icon arm_padding_top_8\' align=\'middle\' style=\''.$badge_css.'\' /><span class=\'arm_badge_title\'>'.stripslashes_deep($badge->arm_badges_name).'</span>"><img src="' . ($badge->arm_badges_icon) . '" alt="" class="arm_badge_icon .arm_padding_top_5" align="middle" style="'.$badge_css.'" /><span class="arm_badge_title">'.stripslashes_deep($badge->arm_badges_name).'</span></li>';
                                                                        }
                                                                    }
                            ...
                            $arm_achivement_edit_response .= '<div class="arm_achievement_helptip_icon arm_margin_bottom_20">
                                                            ...
                                                            <dd>
                                                                ...
                                                                if(!empty($badges_list))
                                                                {
                                                                    foreach ($badges_list as $badge) 
                                                                    {
                                                                        ...
                                                                        */
                                                                        $arm_achivement_edit_response .= '<li data-value="'.esc_attr($badge->arm_badges_id).'" data-label="<img src=\'' . esc_attr($badge->arm_badges_icon) . '\' alt=\'\' class=\'arm_badge_icon arm_padding_top_8\' align="middle" style=\''.$badge_css.'\' /><span class=\'arm_badge_title\'>'.stripslashes_deep($badge->arm_badges_name).'</span>"><img src="' . esc_attr($badge->arm_badges_icon) . '" alt="" class="arm_badge_icon .arm_padding_top_5" align="middle" style="'.$badge_css.'" /><span class="arm_badge_title">'.stripslashes_deep($badge->arm_badges_name).'</span></li>';
            ...
            if (!empty($allAchievements)){
                ...
                foreach ($allAchievements as $badges){
                    ...
                    if (!empty($badges->arm_badges_achievement)) {
                        ...
                        $gridAction .= "<a class='arm_edit_achievements_btn arm_padding_0' href='javascript:void(0);' data-achievement_id='" . $badgesID . "'><img src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_edit.svg' onmouseover=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_edit_hover.svg';\" class='armhelptip' title='" . esc_html__('Edit Achievement', 'ARMember') . "' onmouseout=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_edit.svg';\" /></a>";
                        $gridAction .= "<a href='javascript:void(0)' onclick='showConfirmBoxCallback({$badgesID});'><img src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_delete.svg' class='armhelptip' title='" . esc_html__('Delete', 'ARMember') . "' onmouseover=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_delete_hover.svg';\" onmouseout=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_delete.svg';\" /></a>";
        ...
        function arm_get_user_badges_grid_data(){
            ...
            if (!empty($badges_list)) {
                ...
                foreach ($badges_list as $key => $badges) {
                    ...
                    $gridAction = "<div class='arm_grid_action_btn_container'>";
                    $gridAction .= "<a class='arm_edit_badges_btn arm_padding_0' href='javascript:void(0);' data-badge_id='" . $badgeID . "'><img src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_edit.svg' onmouseover=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_edit_hover.svg';\" class='armhelptip' title='" . esc_html__('Edit Badge', 'ARMember') . "' onmouseout=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_edit.svg';\" /></a>";
                    $gridAction .= "<a href='javascript:void(0)' onclick='showConfirmBoxCallback({$badgeID});'><img src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_delete.svg' class='armhelptip' title='" . esc_html__('Delete', 'ARMember') . "' onmouseover=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_delete_hover.svg';\" onmouseout=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_delete.svg';\" /></a>";
