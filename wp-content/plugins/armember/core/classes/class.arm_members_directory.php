...
$arm_template_html = '<div class="arm_profile_detail_wrapper">
            ...
            if (isset($_POST['action']) && $_POST['action'] == 'arm_membership_card_template_edit_popup') {//phpcs:ignore
                ...
                if (!empty($temp_id)) {
                    ...
                    if(!empty($template)) {
                        ...
                        $popup = '<form action="#" method="post" onsubmit="return false;" class="arm_membership_card_template_edit_form arm_admin_form" id="arm_membership_card_template_edit_form" data-temp_id="'.esc_attr($temp_id).'" onsubmit="return false" enctype="multipart/form-data">';
                        $popup .= '<table cellspacing="0">';
                        $popup .= '<tr>';
        ...
        function arm_get_membership_card_template_options_wrapper($card_type='add', $card_opts = '') {
            ...
            $arm_html_cnt .= "<div class='page_sub_title'>".esc_html__('Template Options', 'ARMember')."</div>";
            ...
            $arm_html_cnt .= "<div class='arm_opt_title arm_margin_top_20 arm_margin_bottom_0'>".esc_html__('Card Template Name', 'ARMember')."</div>";
            ...
            $arm_html_cnt .= "<div class='arm_opt_title arm_margin_top_20 arm_margin_bottom_24 arm_font_size_20 arm_font_weight_500 arm_black_600'>".esc_html__('Other Options','ARMember')."</div>";
            ...
            $arm_html_cnt .= "<div class='arm_temp_opt_box arm_width_100_pct'>";
                    ...
                    <div class="arm_add_template_options_wrapper">
                        ...
                        <div class="arm_template_option_block">
                            <div class="arm_directory_template_name_div arm_form_fields_wrapper arm_width_32_pct">
                                <div class="arm_opt_title arm_margin_top_20 arm_margin_bottom_0">'. esc_html__('Directory Template Name', 'ARMember').'</div>
						...
						<div class="arm_template_option_block arm_template_other_option_block">
							<div class="arm_opt_title arm_margin_top_20 arm_margin_bottom_24 arm_font_size_20 arm_font_weight_500 arm_black_600">'. esc_html__('Other Options','ARMember').'</div>
							<div class="arm_opt_content">
