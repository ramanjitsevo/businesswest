                    ...
                    if ($type == 'profile') {
                        ...
                        if(!empty($armSearchType) && $searchbox)
                        {
                            ...
                            if ($searchbox) {
                                ...
                                if(!empty($armSearchType)){
                                    ...
                                    $arm_directory_filter_btn_content .= '<button class="arm_directory_clear_btn arm_directory_search_btn"><img id="arm_reset_img" width="24" height="24" style="" src="' . MEMBERSHIP_IMAGES_URL . '/reset-button.png"><span>'.$arm_directory_reset_button.'</span></button>';
                        ...
                        else
                        {
                            ...
                            if ($searchbox) {
                                ...
                                $content .= '<a class="arm_directory_clear_btn arm_directory_search_btn"><img id="arm_reset_img" width="24" height="24" style="" src="' . MEMBERSHIP_IMAGES_URL . '/reset-button.png"></a>';
                                $content .= '<img id="arm_loader_img" width="24" height="24" style="position: relative; display: none; float: right; margin-left: 5px; " src="' . MEMBERSHIPLITE_IMAGES_URL . '/arm_loader.gif" alt="Loading..">';
                                $content .= '</div>';
                            } else {
                                $content .= '<input type="hidden" name="search" value="">';
                            }
