                        ...
                        if($arm_plan_condition)
                        {
                            ...
                            if ($expiry_date != '') {
                                ...
                                $arm_edit_plan .= "<a class='arm_member_edit_plan' >"
                                        . "<img src='" . MEMBERSHIPLITE_IMAGES_URL . "/edit_icon.svg' width=20 height=20 onmouseover=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/edit_icon_hover.svg'\" onmouseout=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/edit_icon.svg'\" style='position: absolute; margin: -4px 0 0 5px; cursor: pointer;' width='26' title='" . esc_attr__('Change Expiry Date', 'ARMember') . "' class='armhelptip tipso_style'/>"
                                        . "</a>";
                                $arm_edit_plan .= "<img src='" . MEMBERSHIPLITE_IMAGES_URL . "/save_icon_transp.svg' style='display:none;' width=20 height=20 title='" . esc_attr__('Save Expiry Date', 'ARMember') . "' onmouseover=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/save_icon_transp_hover.svg'\" onmouseout=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/save_icon_transp.svg'\" class='arm_margin_left_10 arm_edit_plan_action_button arm_member_save_plan armhelptip tipso_style arm_vertical_align_sub' data-plan_id='" . esc_attr($uplans) . "' data-user_id='" . esc_attr($user_id) . "' />";
                                $arm_edit_plan .= "<img src='" . MEMBERSHIPLITE_IMAGES_URL . "/arm_cancel_transp.svg' onmouseover=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/arm_cancel_transp_hover.svg'\" onmouseout=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/arm_cancel_transp.svg'\" style='display:none;margin-top:-3px;' title='" . esc_attr__('Cancel', 'ARMember') . "' class='arm_margin_left_10 arm_edit_plan_action_button arm_member_cancel_save_plan armhelptip tipso_style' data-plan_id='" . esc_attr($uplans) . "' data-user_id='" . esc_attr($user_id) . "' data-plan-expire-date='" . date('m/d/Y', $expiry_date) . "' />&nbsp;";
