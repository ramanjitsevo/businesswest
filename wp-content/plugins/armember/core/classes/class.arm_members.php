    ...
    class ARM_members {
        ...
        function arm_member_edit_plan_details_func($response_plans_data,$user_id,$planIDs,$futurePlanIDs)
        {
            ...
            if (!empty($planIDs) || !empty($futurePlanIDs)) {
                ...
                $response_plans_data .= '<tr class="arm_member_subs_plans"><td colspan="2" class="arm_padding_left_32 arm_padding_right_32">
                                                            ...
                                                            if ($planObj->is_recurring() && $planData['arm_payment_mode'] == 'manual_subscription' && !in_array($pID, $futurePlanIDs)) {
                                                                ...
                                                                $response_plans_data .= '<div class="arm_position_relative arm_float_left">';
                                                                    ...
                                                                    if ($total_recurrence != $completed_rec) {
                                                                        $response_plans_data .= '<a href="javascript:void(0)" class="arm_user_renew_next_cycle_action_btn" id="arm_skip_next_cycle" onclick="showConfirmBoxCallback(\'renew_next_cycle_'. esc_attr($pID) .'\');">'. esc_html__('Renew Cycle', 'ARMember') .'</a>
                                                                    ...
                                                                    $response_plans_data .= '<div class="arm_position_relative arm_float_left">
                                                                        ...
                                                                        <div class="arm_confirm_box arm_member_edit_confirm_box" id="arm_confirm_box_delete_user_plan_'. esc_attr($pID).'" style="top:25px; right: -20px; ">
                                                                            <div class="arm_confirm_box_body">
                                                                                ...
                                                                                <div class="arm_confirm_box_btn_container arm_display_flex">
                                                                                    <button type="button" class="arm_confirm_box_btn armcancel" onclick="hideConfirmBoxCallback();">'. esc_html__('Cancel', 'ARMember').'</button>
                                                                                    <button type="button" class="arm_confirm_box_btn armemailaddbtn arm_remove_user_plan_div_box arm_margin_left_12"  data-index="'. esc_attr($count_plans) .'" >'. esc_html__('Ok', 'ARMember') .'</button>
                                                                                </div>
                                                                            </div>
                                                                        </div></div>';
                                                                }
                                        ...
                                        <ul class="arm_user_plan_ul2" id="arm_user_plan_ul2">
                                            <li class="arm_user_plan_li_0 arm_margin_bottom_10">
                                                ...
                                                <div class="arm_user_plns_box">
                                                    <div class="arm_subscription_paid_post_wrapper">
                                                        <input type="hidden" class="arm_user_plan_change_input arm_mm_user_post_change_input_get_cycle arm-selectpicker-input-control" name="arm_user_plan2[]" id="arm_user_post_0" value="" data-arm-plan-count="0"/>
                        ...
                        <li class="arm_user_plan_li_0 arm_margin_bottom_10">
                            ...
                            <div class="arm_user_plns_box">
                                <div class="arm_subscription_plan_selection">
                                    ...
                                    <input type="hidden" id="arm_user_plan" class="arm_user_plan_change_input arm_add_edit_user_plan_change_input arm_user_plan_change_input_get_cycle" name="arm_user_plan" value="" data-manage-plan-grid="2"/>
        ...
        function arm_member_grid_membership_plans_fields_filter_func($arm_others_field_filters,$all_plans,$filter_member_status){
            ...
            $arm_others_field_filters ='
                <tr class="arm_child_user_row">
                    <th>'.esc_html__('Member status','ARMember').'</th>
                    <td>
            ...
            if($is_multiple_membership_feature->isMultipleMembershipFeature) {
                $arm_others_field_filters .='
                <tr class="arm_child_user_row">
                    <th>'.esc_html__('Membership Type','ARMember').'</th>
                    <td>
        ...
        function arm_member_grid_meta_fields_filter_func($arm_meta_field_filters,$user_meta_keys){
            ...
            if (!empty($arm_formfields)) {
                $arm_meta_field_filters = '<tr class="arm_child_user_row">
                    <th>
                        '. esc_html__('Select field','ARMember').'
                    </th><td>';
        ...
        function arm_get_user_all_plan_details($user_id = 0, $is_ajax = true, $is_paid_post = false, $is_gift_plan = false) {
            ...
            if (!empty($user_id)) {
                ...
                if ($is_multiple_membership_feature->isMultipleMembershipFeature || $is_paid_post) {
                    $return .= '<input type="hidden" class="arm_user_plan_change_input arm_user_plan_change_input_get_cycle" name="arm_user_plan[]" id="arm_user_popup_plan" value="" data-manage-plan-grid="1"/>';
                } else {
                    $return .= '<input type="hidden" class="arm_user_plan_change_input arm_user_plan_change_input_get_cycle" name="arm_user_plan" id="arm_user_popup_plan" value="" data-manage-plan-grid="1"/>';
                }
                        ...
                        if($arm_plan_condition)
                        {
                            ...
                            if (!empty($suspended_plan_ids)) {
                                if (in_array($uplans, $suspended_plan_ids)) {
                                    ...
                                    $arm_plan_is_suspended .= "<div class='arm_confirm_box arm_confirm_box_status_".esc_attr($uplans)."' id='arm_confirm_box_plan_status_".esc_attr($uplans)."' style='right: 0;'>";
                            ...
                            $arm_delete_plan .= '<img src="' . MEMBERSHIPLITE_IMAGES_URL . '/grid_delete_icon_trans.svg"  title="' . esc_attr__('Delete Plan', 'ARMember') . '" class="arm_edit_plan_action_button armhelptip tipso_style" id="arm_member_delete_plan" data-plan_id="' . esc_attr($uplans) . '" data-user_id="' . esc_attr($user_id) . '" onclick="showConfirmBoxCallback_plan(' . $uplans . ');"/>';
                            ...
                            if ($expiry_date != '') {
                                ...
                                $arm_edit_plan .= "<a class='arm_member_edit_plan' >"
                                        . "<img src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_edit_hover_trns.png' style='position: absolute; margin: -4px 0 0 5px; cursor: pointer;' width='26' title='" . esc_attr__('Change Expiry Date', 'ARMember') . "' class='armhelptip tipso_style'/>"
                                        . "</a>";
                                $arm_edit_plan .= "<img src='" . MEMBERSHIPLITE_IMAGES_URL . "/arm_save_icon.png' style='display:none;' width='14' height='16' title='" . esc_attr__('Save Expiry Date', 'ARMember') . "' class='arm_edit_plan_action_button arm_member_save_plan armhelptip tipso_style arm_vertical_align_middle' data-plan_id='" . esc_attr($uplans) . "' data-user_id='" . esc_attr($user_id) . "' />&nbsp;";
                                $arm_edit_plan .= "<img src='" . MEMBERSHIPLITE_IMAGES_URL . "/cancel_date_icon.png' style='display:none;' width='14' height='16' title='" . esc_attr__('Cancel', 'ARMember') . "' class='arm_edit_plan_action_button arm_member_cancel_save_plan armhelptip tipso_style' data-plan_id='" . esc_attr($uplans) . "' data-user_id='" . esc_attr($user_id) . "' data-plan-expire-date='" . date('m/d/Y', $expiry_date) . "' />&nbsp;";
        ...
        function arm_manage_plan_get_cycle() {
            ...
            if (!empty($_REQUEST['action']) && !empty($_REQUEST['plan_id'])) {//phpcs:ignore
                ...
                if (!$plan->is_lifetime() && $plan->is_recurring()) {
                    ...
                    $plansCycleLabel = '<span class="arm_subscription_paid_post_label arm_margin_left_12">' . esc_attr__('Select Payment Cycle', 'ARMember') . '</span>';
        ...
        */
        ...
        function arm_change_user_status($user_data_action = array()) {
            ...
            if (!empty($user_id) && $user_id != 0) {
                ...
                if ((get_current_user_id() != $userID) && !is_super_admin($userID)) {
                    if ($primary_status == '3') {
                        ...
                        if (!empty($activation_key) && $activation_key != '') {
                            $gridAction .= "<a href='javascript:void(0)' class='arm_resend_user_confirmation_link' onclick='showResendVerifyBoxCallback(".esc_attr($userID).");'><img src='" . MEMBERSHIPLITE_IMAGES_URL . "/resend_mail_icon.svg' class='armhelptip' title='" . esc_attr__('Resend Verification Email', 'ARMember') . "' onmouseover=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/resend_mail_icon_hover.svg';\" onmouseout=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/resend_mail_icon.svg';\" /></a>";
                ...
                $gridAction .= "<a class='arm_openpreview arm_openpreview_popup armhelptip' href='javascript:void(0)' data-id='" . esc_attr($userID) . "' title='" . esc_attr__('View Detail', 'ARMember') . "'><img src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_preview.svg' onmouseover=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_preview_hover.svg';\" onmouseout=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_preview.svg';\" /></a>";
                if (current_user_can('arm_manage_members')) {
                    $edit_link = admin_url('admin.php?page=' . $arm_slugs->manage_members . '&action=edit_member&id=' . $userID);
                    $gridAction .= "<a href='" . esc_url($edit_link) . "' class='armhelptip' title='" . esc_attr__('Edit Member', 'ARMember') . "' ><img src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_edit.svg' onmouseover=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_edit_hover.svg';\" onmouseout=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_edit.svg';\" /></a>";
                }
                if ((get_current_user_id() != $userID) && !is_super_admin($userID)) {
                    $gridAction .= "<a href='javascript:void(0)' onclick='showChangeStatusBoxCallback(".esc_attr($userID).");'><img src='" . MEMBERSHIPLITE_IMAGES_URL . "/change_status_icon.svg' class='armhelptip' title='" . esc_attr__('Change Status', 'ARMember') . "' onmouseover=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/change_status_icon_hover.svg';\" onmouseout=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/change_status_icon.svg';\" /></a>";
                ...
                $gridAction .= "<a href='javascript:void(0)' class='arm_view_manage_plan_btn' id='arm_manage_plan_" . esc_attr($userID) . "' data-user_id='" . esc_attr($userID) . "'><img src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_manage_plan_icon.svg' class='armhelptip' title='" . esc_attr__('Manage Plans', 'ARMember') . "' onmouseover=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_manage_plan_icon_hover.svg';\" onmouseout=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_manage_plan_icon.svg';\" /></a>";
                ...
                if (!empty($grid_columns)) {
					...
					$grid_data[$ai][$n] = '<a class="arm_open_paid_plan_popup" href="javascript:void(0)" data-id="' . esc_attr($userID) . '">' . esc_html($arm_paid_post_counter) . '</a>';
                            ...
                            case 'action_btn':
                                ...
                                if (current_user_can('arm_manage_members')) {
                                    //$edit_link = admin_url('admin.php?page=' . $arm_slugs->manage_members . '&action=edit_member&id=' . $userID);
                                    $gridAction .= "<a href='javascript:void(0)' class='arm_edit_member_data pro armhelptip' title='" . esc_attr__('Edit Member', 'ARMember') . "' data-id='".$userID."'><img src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_edit.svg' onmouseover=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_edit_hover.svg';\" onmouseout=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_edit.svg';\" /></a>";
                                }
                                if ((get_current_user_id() != $userID) && !is_super_admin($userID)) {
                                    $gridAction .= "<a href='javascript:void(0)' onclick='showChangeStatusBoxCallback(".esc_attr($userID).");'><img src='" . MEMBERSHIPLITE_IMAGES_URL . "/change_status_icon.svg' class='armhelptip' title='" . esc_attr__('Change Status', 'ARMember') . "' onmouseover=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/change_status_icon_hover.svg';\" onmouseout=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/change_status_icon.svg';\" /></a>";
                                    $gridAction .= "<div class='arm_confirm_box arm_change_status_box arm_change_status_box_".esc_attr($userID)."' id='arm_change_status_box_".esc_attr($userID)."' >";
                                ...
                                $gridAction .= "<a href='javascript:void(0)' class='arm_view_manage_plan_btn' data-user_id ='".esc_attr($userID)."' id='arm_manage_plan_" . esc_attr($userID) . "'><img src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_manage_plan_icon.svg' class='armhelptip' title='" . esc_attr__('Manage Plans', 'ARMember') . "' onmouseover=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_manage_plan_icon_hover.svg';\" onmouseout=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_manage_plan_icon.svg';\" /></a>";

                                if (current_user_can('arm_manage_members') && (get_current_user_id() != $userID)) {
                                    if (is_multisite() && is_super_admin($userID)) {
                                        /* Hide delete button for Super Admins */
                                    } else {
                                        $gridAction .= "<a href='javascript:void(0)' onclick='showConfirmBoxCallback({$userID});'><img src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_delete.svg' class='armhelptip' title='" . esc_attr__('Delete', 'ARMember') . "' onmouseover=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_delete_hover.svg';\" onmouseout=\"this.src='" . MEMBERSHIPLITE_IMAGES_URL . "/grid_delete.svg';\" /></a>";
        ...
        function arm_get_failed_login_attempts_history($current_page = 1, $perPage = 10) {
            ...
            $historyHtml .= '<div class="popup_content_text arm_failed_login_history_table arm_failed_attempt_loginhistory_wrapper arm_padding_top_32 arm_padding_left_32 arm_padding_right_32">';
