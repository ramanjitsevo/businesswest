    ...
    class ARM_manage_communication {
        ...
        function arm_message_operation() {
           ...
           // }
            ...
            $gridActionConfirmbox = $arm_global_settings->arm_get_confirm_box($mid, esc_html__("Are you sure Are you sure you want to delete this message?", 'ARMember'), 'arm_communication_delete_btn','',esc_html__("Delete", 'ARMember'),esc_html__("Cancel", 'ARMember'),esc_html__("Delete", 'ARMember'));
            ...
            $arm_message_response_html .= '
                ...
                <div class="divTableCell arm_grid_action_wrapper hidden_section" bis_skin_checked="1" style="display: none;">
                    <div class="arm_grid_action_wrapper arm_margin_top_12" bis_skin_checked="1">
                        <div class="arm_grid_action_btn_container arm_margin_right_24" bis_skin_checked="1">
                            <a class="arm_edit_message_btn pro arm_margin_right_5" href="javascript:void(0);" data-message_id="'.$mid.'"><img src="'.MEMBERSHIPLITE_IMAGES_URL.'/grid_edit.svg" onmouseover="this.src=\''.MEMBERSHIPLITE_IMAGES_URL.'/grid_edit_hover.svg\';" class="armhelptip tipso_style" title="'.esc_html__('Edit','ARMember').'" onmouseout="this.src=\''.MEMBERSHIPLITE_IMAGES_URL.'/grid_edit.svg\';"></a>
                            <a class="arm_test_mail_btn_pro arm_margin_right_5" href="javascript:void(0);" data-message_id="'.$mid.'"><img src="'.MEMBERSHIPLITE_IMAGES_URL.'/resend_mail_icon.svg" onmouseover="this.src=\''.MEMBERSHIPLITE_IMAGES_URL.'/resend_mail_icon_hover.svg\';" class="armhelptip tipso_style" title="'.esc_html__('Resend Email','ARMember').'" onmouseout="this.src=\''.MEMBERSHIPLITE_IMAGES_URL.'/resend_mail_icon.svg\';"></a>
                            <a href="javascript:void(0)" onclick="showConfirmBoxCallback('.$mid.');"><img src="'.MEMBERSHIPLITE_IMAGES_URL.'/grid_delete.svg" class="armhelptip tipso_style" onmouseover="this.src=\''.MEMBERSHIPLITE_IMAGES_URL.'/grid_delete_hover.svg\';" onmouseout="this.src=\''.MEMBERSHIPLITE_IMAGES_URL.'/grid_delete.svg\';"></a>
