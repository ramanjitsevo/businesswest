...
if (!class_exists('ARM_membership_setup')) {
    ...
    class ARM_membership_setup {
			...
			$grid_data[$ai][1] = $setup_type;                    
                    ...
                    $grid_data_action_btn = '<div class="arm_grid_action_btn_container">
                        <a href="javascript:void(0)" class="arm_get_form_link arm_edit_setup_form_link" data-form_id="'. intval($setupID).'">
                            <img src="'. esc_attr(MEMBERSHIPLITE_IMAGES_URL).'/grid_edit.svg" onmouseover="this.src=\''. esc_attr(MEMBERSHIPLITE_IMAGES_URL).'/grid_edit_hover.svg\';" class="armhelptip" title="'. esc_attr__( 'Edit Setup', 'ARMember' ).'" onmouseout="this.src=\''. esc_attr(MEMBERSHIPLITE_IMAGES_URL).'/grid_edit.svg\';" />
                        </a>
                        <a href="javascript:void(0)" onclick="showConfirmBoxCallback('. intval($setupID).');" data-form_id="'.  intval($setupID).'">
                            <img src="'. esc_attr(MEMBERSHIPLITE_IMAGES_URL).'/grid_delete.svg" class="armhelptip" title="'. esc_attr__( 'Delete Setup', 'ARMember' ).'" onmouseover="this.src=\''. esc_attr(MEMBERSHIPLITE_IMAGES_URL).'/grid_delete_hover.svg\';" onmouseout="this.src=\''. esc_attr(MEMBERSHIPLITE_IMAGES_URL).'/grid_delete.svg\';" style="cursor:pointer"/>
                        </a>';
        ...
        function arm_pro_two_step_feature_section_func($arm_styling_plan_skin_section, $setup_data,$setup_modules){
            ...
            <div class="arm_setup_section_title"><span class="arm_title_round">4</span>'. esc_html__( 'Signup Steps', 'ARMember' ).'</div>
            ...
            <div class="arm_setup_section_body">
                ...
                $arm_styling_plan_skin_section .= '<div class="arm_setup_option_field enable_two_steps" '.$arm_styling_two_step_section_css.'>
        ...
        function arm_setup_form_styling_additional_fields_func($arm_setup_additional_form_fields,$setup_data,$setup_modules){
            ...
            $arm_setup_additional_form_fields = '<div class="arm_solid_divider arm_pro_solid_divider"></div>
            <div class="arm_setup_section_title arm_margin_bottom_24 arm_font_size_16">'.esc_html__( 'Font settings', 'ARMember' ).'</div>';
        ...
        function arm_setup_additional_basic_option_section_func($arm_setup_additional_basic_options,$setup_modules){
            ...
            if ($arm_manage_coupons->isCouponFeature){
                ...
                $arm_setup_additional_basic_options .= '<div class="arm_setup_option_field arm_setup_coupon_section">
        ...
        function arm_pro_add_new_register_form_btn_field_func($arm_add_new_form_btn){
            global $arm_slugs;
            $arm_add_new_form_btn = '<a href="'. esc_url(admin_url('admin.php?page='.$arm_slugs->manage_forms.'&setup=true')).'" target="_blank" class="arm_setup_conf_links arm_ref_info_links arm_add_new_form">'. esc_html__('Add New Form', 'ARMember').'</a>';
