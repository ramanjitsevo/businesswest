        ...
        function arm_load_coupon_data()
        {
            ...
            if( !empty( $get_coupons ))
            {
                ...
                foreach ($get_coupons as $key => $coupon_val) 
                {
                    ...
                    $gridActionData .= '<a href="javascript:void(0)" class="arm_edit_coupon_data_btn" data-coupon_id="'.$couponID.'"><img src="'.MEMBERSHIPLITE_IMAGES_URL.'/grid_edit.svg" onmouseover=\'this.src="'.MEMBERSHIPLITE_IMAGES_URL.'/grid_edit_hover.svg";\' class="armhelptip" title="'.esc_attr__('Edit Coupon','ARMember').'" onmouseout=\'this.src="'.MEMBERSHIPLITE_IMAGES_URL.'/grid_edit.svg";\' /></a>';
                    $gridActionData .= '<a href="javascript:void(0)" onclick="showConfirmBoxCallback('.$couponID.');"><img src="'.MEMBERSHIPLITE_IMAGES_URL.'/grid_delete.svg" class="armhelptip" title="'.esc_attr__('Delete','ARMember').'" onmouseover=\'this.src="'.MEMBERSHIPLITE_IMAGES_URL.'/grid_delete_hover.svg";\' onmouseout=\'this.src="'.MEMBERSHIPLITE_IMAGES_URL.'/grid_delete.svg";\' /></a>';
        ...
        function arm_coupon_form_html($c_discount,$c_type,$period_type,$sdate_status,$edit_mode,$c_sdate,$c_edate,$c_allow_trial,$c_allowed_uses,$c_label,$c_coupon_on_each_subscriptions,$coupon_status,$c_subs,$c_data, $arm_coupon_type = 1, $arm_paid_posts = array(),$is_bulk_create=0){
            ...
            $arm_coupon_form_html .='<tr class="form-field form-required arm_margin_top_24">
                        ...
                        $arm_coupon_form_html .='<tr class="form-field form-required">
                                                ...
                                                <div class="arm_solid_divider arm_margin_bottom_24 arm_margin_top_24"></div>                                               
                                                </td>
                                            </tr>';
                                            $arm_coupon_form_html .='<tr class="form-field form-required arm_width_100_pct">
                                                <td class="arm_padding_0 arm_margin_top_10">
