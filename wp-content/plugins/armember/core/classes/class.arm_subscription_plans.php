...
if (!class_exists('ARM_subscription_plans')) {
    ...
    class ARM_subscription_plans {
            ...
            if (!empty($form_result)) {
                ...
                foreach($form_result as $planData) {
                    ...
                    if( $planObj->is_recurring() && isset($planObj->options['payment_cycles']) && count($planObj->options['payment_cycles']) > 1 ) {
                        ...
                        <a href="javascript:void(0);" class="arm_margin_left_10" onclick="arm_plan_cycle('. esc_attr($planID) .')">' . esc_html__('Multiple Cycle', 'ARMember') . '</a>';
                    } else {
        ...
        function arm_get_plan_limit_settings_content($plan_options){
            ...
            $arm_paid_post_plan_settings .= '<div class="arm_solid_divider arm_margin_top_0 arm_margin_bottom_32"></div>';
            $arm_paid_post_plan_settings .= '<div class="form-field arm_plan_price_section arm_addon_section">';
            $arm_paid_post_plan_settings .= '<div class="arm_setup_section_title arm_margin_top_20 arm_margin_bottom_24">'. esc_html__('Membership Plan Purchase Limit Settings','ARMember') . '</div>';
                $arm_paid_post_plan_settings .= '<div id="arm_plan_price_box_content" class="arm_plan_price_box">';
                    ...
                    $arm_paid_post_plan_settings .= '<table width="100%" class="form-table">';
                        ...
                        $arm_paid_post_plan_settings .= '<th class="arm_custom_addon_label arm_padding_0">';
                                $arm_paid_post_plan_settings .= '
