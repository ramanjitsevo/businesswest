...
<div class="arm_members_list">
    <form method="POST" id="arm_referral_list_form" class="data_grid_list" enctype="multipart/form-data">
        ...
        <div id="armmainformnewlist" class="arm_filter_grid_list_container">
            ...
            <input type="hidden" name="search_grid" id="search_grid" value="<?php esc_html_e('Search','ARM_DIRECT_LOGINS');?>"/>
            <input type="hidden" name="entries_grid" id="entries_grid" value="<?php esc_html_e('Direct Login','ARM_DIRECT_LOGINS');?>"/>
            <input type="hidden" name="show_grid" id="show_grid" value="<?php esc_html_e('Show','ARM_DIRECT_LOGINS');?>"/>
            <input type="hidden" name="showing_grid" id="showing_grid" value="<?php esc_html_e('Showing','ARM_DIRECT_LOGINS');?>"/>
            <input type="hidden" name="to_grid" id="to_grid" value="<?php esc_html_e('to','ARM_DIRECT_LOGINS');?>"/>
            <input type="hidden" name="of_grid" id="of_grid" value="<?php esc_html_e('of','ARM_DIRECT_LOGINS');?>"/>
            <input type="hidden" name="no_match_record_grid" id="no_match_record_grid" value="<?php esc_html_e('No matching direct login found.','ARM_DIRECT_LOGINS');?>"/>
            <input type="hidden" name="no_record_grid" id="no_record_grid" value="<?php esc_html_e('No any direct login found.','ARM_DIRECT_LOGINS');?>"/>
            <input type="hidden" name="filter_grid" id="filter_grid" value="<?php esc_html_e('filtered from','ARM_DIRECT_LOGINS');?>"/>
            <input type="hidden" name="totalwd_grid" id="totalwd_grid" value="<?php esc_html_e('total','ARM_DIRECT_LOGINS');?>"/>
