        ...
        <div class="page_title">
            ...
            <div class="arm_add_new_item_box">
                <a class="greensavebtn arm_add_direct_login" href="javascript:void(0);">
                    <img align="absmiddle" src="<?php echo esc_url(ARM_DIRECT_LOGINS_IMAGES_URL); ?>add_new_icon.png" />
            ...
            <tr class="popup_wrapper_inner">	
                ...
                <td class="popup_content_text">
                    <table class="arm_table_label_direct_logins">	
                        ...
                        <tr class="new_user_section">
                            <th><?php _e('Email Address', 'ARM_DIRECT_LOGINS');?></th>
                            <td class="arm_required_wrapper">
                ...
                <td class="popup_content_btn popup_footer">
                    <div class="popup_content_btn_wrapper">
                        <img src="<?php echo MEMBERSHIPLITE_IMAGES_URL.'/arm_loader.gif' ?>" id="arm_loader_img" class="arm_loader_img" style="position: relative;top: 15px;display: none;float: <?php echo (is_rtl()) ? 'right' : 'left';?>;" width="20" height="20" />
    ...
    <form method="post" action="#" id="arm_edit_direct_logins_wrapper_frm" class="arm_admin_form arm_edit_direct_logins_wrapper_frm <?php echo is_rtl() ? 'arm_page_rtl' : ''; ?>">
        <table cellspacing="0">
            <tr class="popup_wrapper_inner">	
                ...
                <td class="popup_header"><?php esc_html_e('Edit Direct Login', 'ARM_DIRECT_LOGINS');?></td>
                ...
                <td class="popup_content_text">
                    <table class="arm_table_label_direct_logins">
                        ...
                        <tr class="form-field edit_exists_user_section" id="select_user">
                            <th class="arm-form-table-label"><?php esc_html_e('Username', 'ARM_DIRECT_LOGINS'); ?></th>
                            <td class="arm-form-table-content">
                        ...
                        <tr><th></th><td></td></tr>
                        <tr>
                            <th><?php esc_html_e('Direct Login Expiration', 'ARM_DIRECT_LOGINS');?></th>
