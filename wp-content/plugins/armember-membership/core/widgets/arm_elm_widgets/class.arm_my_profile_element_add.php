...
class arm_my_profile_shortcode extends Widget_Base
{
    ...
    {
        return esc_html('ARMember My Profile','armember-membership').'<style>
        .arm_element_icon{
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
			'section_content',
			[
				'label' => esc_html__( 'ARMember Profile', 'armember-membership' ),
			]
		);
        $this->add_control(
			'title',
		...
		$this->add_control(
			'arm_show_profiles',
			[
				'label' => esc_html__( 'Profile Fields', 'armember-membership' ),
		...
		if($arm_social_feature->isSocialFeature)
		{
			...
			$this->start_controls_section(
				...
				[
					'label' => esc_html__( 'ARMember Social Profile', 'armember-membership' ),
					]
				);
